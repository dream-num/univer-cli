...
| Verify   | `inspect`                                | Read-only exploration: workbook/sheet/range, presentation (deck overview; `--pages <n\|n-m\|id\|all>` zooms into pages, 1-based), or document/paragraph, or Base schema overview.                                       |
