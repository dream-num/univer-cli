...
function localeModule(tag) {
  return `import basesHistoryUI from "@univerjs-pro/bases-history-ui/locale/${tag}";\nimport boardsHistoryUI from "@univerjs-pro/boards-history-ui/locale/${tag}";\nimport collaborationClient from "@univerjs-pro/collaboration-client/locale/${tag}";\nimport collaborationClientUI from "@univerjs-pro/collaboration-client-ui/locale/${tag}";\nimport docsHistoryUI from "@univerjs-pro/docs-history-ui/locale/${tag}";\nimport editHistoryUI from "@univerjs-pro/edit-history-ui/locale/${tag}";\nimport exchangeClient from "@univerjs-pro/exchange-client/locale/${tag}";\nimport sheetsHistoryUI from "@univerjs-pro/sheets-history-ui/locale/${tag}";\nimport slidesHistoryUI from "@univerjs-pro/slides-history-ui/locale/${tag}";\nimport { loadContentLocale, mergeLocalePacks } from "@univer/render-preset";\nimport type { ILanguagePack } from "@univerjs/core";\n\nexport default async function loadLocale(): Promise<ILanguagePack> {\n  const content = await loadContentLocale("${tag}");\n  return mergeLocalePacks([\n    content,\n    collaborationClient,\n    collaborationClientUI,\n    exchangeClient,\n    editHistoryUI,\n    sheetsHistoryUI,\n    docsHistoryUI,\n    slidesHistoryUI,\n    basesHistoryUI,\n    boardsHistoryUI\n  ]);\n}\n`;
}
